...
ui <- navbarPage(title = "SAHEL DSPG 2022",
                 ...
                 tabPanel("Takeaways",
                          ...
                          column(6,
                                 ...
                                 disaggregating the food insecurity data to focus on smaller administrative units that would illustrate greater variation over space, and to evaluate alternative approaches to measure correspondence that may account for nonlinear relationships
")
                          )),
